...
<body>
    <form action="test_signupProcess.php" method="POST" id="signup-form">
        <div class="w-50 ml-auto mr-auto mt-5">
        <div class="mb-3 ">
                <label for="userNickname" class="form-label">아이디</label>
                <input type="text" name="userNickname" class="form-control" id="userNickname" placeholder="아이디를 입력해 주세요.">
            </div>
            <div class="mb-3 ">
